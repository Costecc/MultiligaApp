        ...
        static public List<teamResult> sumTeamsPoints(List<result> allResults)
        {
            ...
            foreach (var result in allResults)
            {
                foreach (var id in result.teamIds)
                {
                    ...
                    {
                        aggregatedPoints.Add(new teamResult
                        {
                            teamId = id,
                    ...
                    else
                    {
                        ...
                        aggregatedPoints[index] = new teamResult
                        {
                            teamId = id,
                            points = aggregatedPoints[index].points + result.points,
                            competitionName = result.competitionName,
                            place = 0,
                            raceName = result.raceName
                        };
